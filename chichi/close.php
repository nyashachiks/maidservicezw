...
<head>
  ...
  <title>Maid Service | Close CV</title>
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/nyasha.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['name']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/nyasha.jpg" class="img-circle" alt="User Image">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Close CV
        <small>Close CV here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Close CV</li>
      </ol>
    </section>
      ...
      <?php
		...
		echo "<table>
			...
			if($rwlist['status']=='PUBLISHED')
				{
				//bottom table
				echo "<div align=\"center\"><h4>Are you sure you want to close this record? (It will be removed from viewers' rotation)</h4>";	
				echo "<table>
						<tr>
							<td width=\"100\">
							</td>
							<td width=\"100\">
								<form action=\"viewPublishedCVs.php\" method=\"POST\">
									<h4><button type=\"submit\" class=\"btn btn-primary\">Yes</button></h4>
										<input type=\"hidden\" name=\"closed\" value=\"Yes\">
