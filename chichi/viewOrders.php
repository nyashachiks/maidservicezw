...
<head>
  ...
  <title>Maid Service | View Orders</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Orders
        <small>Manage orders here</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
	  ...
	  <table>
		<tr bgcolor=\"#212f3c\">
			<td width=20></td>
			<td width=120><b><font color=\"white\"><h4>Mobile</h4></font></b></td>
			<td  width=250><b><font color=\"white\"><h4>Name</h4></font></b></td>
			<td width=380><b><font color=\"white\"><h4>Approval Code (Encrypted)</h4></font></b></td>
			<td width=120><b><font color=\"white\"><h4>Status</h4></font></b></td>
			<td width=80><b><font color=\"white\"><h4>Action</h4></font></b></td>
		</tr>";
		
		$qlist= "SELECT * FROM orders";
		$rlist= mysqli_query($dbhandle, $qlist);
		while($rwlist= mysqli_fetch_array($rlist, MYSQLI_ASSOC)){
			$clientID= $rwlist['client_id'];
			$qlist2= "SELECT * FROM clients WHERE client_id='$clientID'";
			$rlist2= mysqli_query($dbhandle, $qlist2);
			$rwlist2= mysqli_fetch_array($rlist2, MYSQLI_ASSOC);
			$bg=(!isset($bg)=='#f8f9f9' ? '#fdfefe' : '#f8f9f9');
			echo "<tr bgcolor=\"".$bg."\">
				<td></td>
				<td><h4>".$rwlist2['mobile']."</h4></td>
				<td><h4>".$rwlist2['name']."</h4></td>
				<td><h4>".$rwlist['app_code']."</h4></td>
				<td><h4><i>...</i></h4></td>
				<td><h4><i><a href=\"#\" class=\"btn btn-primary btn-lg active\" role=\"button\" aria-pressed=\"true\">Renew</a></i></h4></td>
			</tr>";
		}
