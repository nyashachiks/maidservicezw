...
<head>
  ...
  <title>Maid Service | Edit CV</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php
		...
		if($rwlist['status']=='NEW')
			{
			echo "
				<form action=\"viewNewCVs.php\" method=\"POST\">
				<table>
					<tr>
						<td><img src=\"dist/img/".$rwlist['image'].".jpg\" height=\"300\" width=\"300\"><br>...</td>
						<td width=\"20\"></td>
						<td>
							<table>
								<tr bgcolor=\"#212f3c\">
								...
								<tr bgcolor=\"#f8f9f9\">
									...
									<td><h4><input type=\"text\" name=\"name\" size=\"30\" maxlength=\"50\" value=\"".$rwlist['name']." ".$rwlist['surname']."\"></td>
								</tr>
								<tr bgcolor=\"#f8f9f9\">
									<td></td>
									<td width=\"200\"><h4><b>ID:</b></h4></td>
									<td><h4><input type=\"text\" name=\"idNum\" size=\"30\" maxlength=\"50\" value=\"".$rwlist['id_num']."\"></td>
								</tr>
								<tr bgcolor=\"#f8f9f9\">
									<td></td>
									<td width=\"200\"><h4><b>Address:</b></h4></td>
									<td><h4><input type=\"text\" name=\"address\" size=\"30\" maxlength=\"50\" value=\"".$rwlist['address']."\"></td>
								</tr>
								<tr bgcolor=\"#f8f9f9\">
									<td></td>
								...
								<tr bgcolor=\"#fdfefe\">
									...
									<td><h4><input type=\"text\" name=\"email\" size=\"30\" maxlength=\"50\" value=\"".$rwlist['email']."\"></h4></td>
								</tr>
								<tr bgcolor=\"#f8f9f9\">
									<td></td>
									<td><h4><b>Mobile: </b></h4></td>
									<td><h4><input type=\"text\" name=\"mobile\" size=\"30\" maxlength=\"50\" value=\"".$rwlist['mobile']."\"></h4></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					echo "
						<table>
							...
							<tr bgcolor=\"#f8f9f9\">
								...
								<td><h5><input type=\"radio\" name=\"marital\" value=\"Single\"> Single <input type=\"radio\" name=\"marital\" value=\"Married\"> Married</h5></td>
								<td><h4><b>Age: </b></h4></td>
							...
							<tr bgcolor=\"#fdfefe\">
								...
								<td><h5><input type=\"radio\" name=\"timeBasis\" value=\"pt\"> Part Time <input type=\"radio\" name=\"timeBasis\" value=\"ft\"> Full Time</h5></td>
								<td><h4><b>Next Of Kin: </b></h4></td>
								<td><h4><input type=\"text\" name=\"nextOfKin\" size=\"50\" maxlength=\"250\" value=\"".$rwlist['next_of_kin']."\"></h4></td>
							</tr>
							<tr bgcolor=\"#f8f9f9\">
								...
								<td><h4><select name=\"religion\">";
											...
											echo "</select></h4></td>
								<td><h4><b>Work Experience: </b></h4></td>
								<td><h4><input type=\"text\" name=\"workExperience\" size=\"50\" maxlength=\"250\" value=\"".$rwlist['work_experience']."\"></h4></td>
							</tr>
						</table>
						<div align=\"center\">
							<table>
								<tr>
									...
									<td width=\"100\">
											<h4><button type=\"submit\" class=\"btn btn-primary\">Save</button></h4>
									...
									<td width=\"200\">
									<form action=\"viewNewCVs.php\" method=\"POST\">
											<h4><button type=\"submit\" class=\"btn btn-secondary\">Discard</button></h4>
										</form>
									</td>
								</tr>
							</table></div>";
					}
			if($rwlist['status']=='PUBLISHED')
				{
				echo "<form action=\"viewPublishedCVs.php\" method=\"POST\">
					<table>
					<tr>
						<td><img src=\"dist/img/".$rwlist['image'].".jpg\" height=\"300\" width=\"300\"><br>...</td>
						<td width=\"20\"></td>
						...
						echo "
							...
							<table>
								<tr>
									...
									<td width=\"200\">
									<form action=\"viewPublishedCVs.php\" method=\"POST\">
											<h4><button type=\"submit\" class=\"btn btn-secondary\">Discard</button></h4>
										</form>
									</td>
								</tr>
				...
				if($rwlist['status']=='CLOSED')
					{
					echo "
					<form action=\"viewClosedCVs.php\" method=\"POST\">
					<table>
					<tr>
						<td><img src=\"dist/img/".$rwlist['image'].".jpg\" height=\"300\" width=\"300\"><br>...</td>
						<td width=\"20\"></td>
