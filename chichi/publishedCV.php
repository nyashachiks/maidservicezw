...
<head>
  ...
  <title>Maid Service | Published CV</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Published CV
        <small>Manage published CV here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Published CV</li>
      </ol>
    </section>
		...
		<table>
			<tr>
				...
				<form action=\"close.php\" method=\"GET\">
						<h4><button type=\"submit\" class=\"btn btn-primary\">Close</button></h4>
