...
<head>
  ...
  <title>Maid Service | Delete CV</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Delete CV
        <small>Delete CV here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Delete CV</li>
      </ol>
    </section>
      ...
      <?php
		...
		echo "<table>
			...
			if($rwlist['status']=='NEW')
				{
				//bottom table
				echo "<div align=\"center\"><h4>Are you sure you want to delete this record?</h4>";	
				echo "<table>
						<tr>
							<td width=\"100\">
							</td>
							<td width=\"100\">
								<form action=\"viewNewCVs.php\" method=\"POST\">
									<h4><button type=\"submit\" class=\"btn btn-danger\">Yes</button></h4>
