...
<head>
  ...
  <title>Maid Service | Closed CV</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Closed CV
        <small>Manage closed CV here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Closed CV</li>
      </ol>
    </section>
			...
			<tr>
				<td width=\"120\">
					<form action=\"publish.php\" method=\"GET\">
						<h4><button type=\"submit\" class=\"btn btn-primary\">Re-Publish</button></h4>
