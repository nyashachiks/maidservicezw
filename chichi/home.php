...
<head>
  ...
  <title>Maid Service | Dashboard</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		$qr3= "SELECT * FROM clients";
		$rr3= mysqli_query($dbhandle, $qr3);
		$rwr3= mysqli_num_rows($rr3);
		
		$qr4= "SELECT * FROM view_count";
		$rr4= mysqli_query($dbhandle, $qr4);
		$rwr4= mysqli_num_rows($rr4);
		?>
        <li class="treeview">
          <a href="#">
