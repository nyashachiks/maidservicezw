...
<head>
  ...
  <title>Maid Service | Publish CV</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Publish CV
        <small>Publish CV here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Publish CV</li>
      </ol>
    </section>
      ...
      <?php
		...
		echo "<table>
			...
			if($rwlist['status']=='NEW')
				{
				//bottom table
				echo "<div align=\"center\"><h4>Are you sure you want to publish this record? (It will be added to viewers' rotation)</h4>";	
				echo "<table>
						<tr>
							<td width=\"100\">
							</td>
							<td width=\"100\">
								<form action=\"viewNewCVs.php\" method=\"POST\">
									<h4><button type=\"submit\" class=\"btn btn-primary\">Yes</button></h4>
							...
							<td width=\"200\">
							<form action=\"viewNewCVs.php\" method=\"POST\">
									<h4><button type=\"submit\" class=\"btn btn-secondary\">No</button></h4>
								</form>
							</td>
						</tr>
					</table></div>";
			...
			if($rwlist['status']=='CLOSED')
				{
				//bottom table
				echo "<div align=\"center\"><h4>Are you sure you want to publish this record? (It will be re-added to viewers' rotation)</h4>";	
				echo "<table>
						<tr>
							<td width=\"100\">
							</td>
