...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View New CVs
        <small>Manage new CVs here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">New CVs</li>
      </ol>
    </section>
	...
	if(isset($_POST['edited'])&&($_POST['edited']=='Yes'))
	  ...
	  <table>
		...
		$qlist= "SELECT * FROM maids WHERE status= 'NEW'";
		...
		while($rwlist= mysqli_fetch_array($rlist, MYSQLI_ASSOC)){
			...
			echo "<tr bgcolor=\"".$bg."\">
				...
				<td><h4><i><a href=\"newCV.php?id=".$rwlist['maid_id']."\" class=\"btn btn-primary btn-lg active\" role=\"button\" aria-pressed=\"true\">View CV</a></i></h4></td>
			</tr>";
		}
